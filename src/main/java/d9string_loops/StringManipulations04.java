...
*/
        ...
        String str1 = new String("merhaba"); // bu sekilde de string olusturabiliriz
        String str2 = new String("merhaba");
        String str3 = str1;

        System.out.println(str1 == str2); //false cunku ref. adresler farkli, == adrese baktigi icin false

        System.out.println(str1.equals(str2)); //true cunku data'lar ayni, equals datalara bakar

        System.out.println(str1==str3); //true cunku adresleri ayni, == adrese baktigi icin dogru, = isaretiyle ayni
                                        // adresi verdik
