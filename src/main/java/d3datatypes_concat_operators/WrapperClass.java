...
public class WrapperClass {
    ...
    method kullaniminin da yolunu acar.*/
        ...
        Integer k = 12; // k. yaptigimizda methodlar acilir cunku integer bir classtir.
       ...
       Unboxing ise tam tersi bir işlem yapar,
        ...
        //Ornek 2 : Wrapper Byte'i primitive byte'a ceviriniz. (Unboxing)- Senaryo geregi methotlara ihtiyacimiz yoktur, java otomatik unboxing yapar.
