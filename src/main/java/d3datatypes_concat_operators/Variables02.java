     ...
     */
        ...
        */
        ...
        System.out.println(cityName);
         ...
         cityName = "Izmir";
        System.out.println(cityName); // degiskenin data tipini daha önce tanimladigimiz icin, data tipitanimlamadan kullanabildik
        //böylece ayni scope (yasam alaninda) alaninda ayni isimli variableye farkli degerler atayabildik

        int a = 12;
        a = 15;
        System.out.println(a); // tek sout komutu olursa en son verilen degeri yazdirir.
