...
public class Switch03 {
    ...
    /*Example 1: Ask the user to enter a month number (between 1 and 12).
        ...
        String season = switch (month) {
            ...
            case 12, 1, 2 -> "Kis"; //burada javaya eger kullanici 12,1,2 rakamlarini girerse buraya "kis" a gel diyoruz
            case 3, 4, 5 -> "Ilkbahar";
            case 6, 7, 8 -> "Yaz";
            case 9, 10, 11 -> "Sonbahar";
            default -> "Bilinmeyen ay";

        }; // burada normal java kodu yazdigimiz icin noktali virgül kullandik  // ctrl + alt + L tuslariyla yazi aralarini otomatik ayarlarsin
        System.out.println("Mevsim : " + season);
        scanner.close(); //scanner object ini kapattik
