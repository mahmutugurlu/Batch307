package d2variables; //package name

public class Variables01 { //class name

    public static void main(String[] args){ //main method

        //Java bu satiri okumaz. Kendimize ve baskasina aciklama koymak icin kullanabiliriz.
        /*
        Birden fazla satir aciklama icin bu isareti kullaniriz
        ...
        int countryPopulation = 52000000;
        System.out.println("ülke nufusu : " + countryPopulation);
