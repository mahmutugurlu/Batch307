...
public class Lambda03 {
    ...
    public static void printElementsExceptStartsWithE(List<String> myList) {
        ...
        myList.stream().filter(t -> !t.startsWith("E")).//akistan gelen degerlere bak E ile baslamamali diyoruz
    ...
    //ornek 2: Bir List<String> içinde karakter sayısı 5'ten az olan tüm benzersiz (tekrarsız) elemanları konsola
    // yazdıran bir metod yazınız.
    //example 2: Write a method that prints all unique (non-repetitive) elements with less than 5 characters in a
    // List<String> to the console.
