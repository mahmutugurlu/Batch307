...
public class Scanner01 {
    ...
    3- next(), nextInt(), nextDouble() gibi farklı metotlar, farklı ihtiyaçlara uygun şekillerde kullanicidan girdi
     almayı sağlar.*/
        ...
        Scanner input = new Scanner(System.in); //object olusturduk
        ...
        byte age = input.nextByte(); // kullanicidan aldigimiz bilgiyi age degiskenine atadik.

        System.out.println("Girilen Yas : " + age);

        //import ile bir classin (kütüphanedeki) özelliklerini projemizde kullanabiliriz.
