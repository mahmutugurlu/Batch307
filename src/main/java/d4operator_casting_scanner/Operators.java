 ...
 */
        ...
        System.out.println(amountOfMoney1 / numberOfPeople1); //2 cikti, 2.5 cikmaliydi, ama java 5 sildi ve tam deger verdi.


        double amountOfMoney2 = 25; //8 byte ondalikli sayi
        int numberOfPeople2 = 10; //4 byte tamsayi
        System.out.println(amountOfMoney2 / numberOfPeople2);//2.5//burada double ve int data türlerini beraber kullandigimiz
                                                                // icin java daha büyük alana sahip olani data türü olarak belirledi ve sonuc virgüllü oldu
